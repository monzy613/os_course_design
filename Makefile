...
haribote.img : haribote/ipl09.bin haribote/haribote.sys Makefile \
		a/a.hrb hello3/hello3.hrb hello4/hello4.hrb hello5/hello5.hrb cbg/cbg.hrb hanoi/hanoi.hrb\
		winhelo/winhelo.hrb winhelo2/winhelo2.hrb winhelo3/winhelo3.hrb \
		star1/star1.hrb stars/stars.hrb stars2/stars2.hrb \
		lines/lines.hrb walk/walk.hrb snake/snake.hrb mypic/mypic.hrb noodle/noodle.hrb \
		beepdown/beepdown.hrb color/color.hrb color2/color2.hrb \
		sosu/sosu.hrb sosu2/sosu2.hrb sosu3/sosu3.hrb \
		type/type.hrb iroha/iroha.hrb chklang/chklang.hrb \
		notrec/notrec.hrb bball/bball.hrb invader/invader.hrb plane/plane.hrb\
	...
	$(EDIMG)   imgin:../z_tools/fdimg0at.tek \
		...
		copy from:hanoi/hanoi.hrb to:@: \
		copy from:cbg/cbg.hrb to:@: \
		...
		copy from:snake/snake.hrb to:@: \
		copy from:mypic/mypic.hrb to:@: \
...
src_only_full :
	...
	$(MAKE) -C snake		src_only
	$(MAKE) -C mypic		src_only
